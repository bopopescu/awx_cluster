            ...
            available:
                description:
                    - The availability status of the failover replica. A false status indicates that the
                      failover replica is out of sync. The main can only failover to the falover replica
        ...
        suboptions:
            failover_target:
                description:
                    ...
                    - In case the main instance fails, the replica instance will be promoted as the
                      new main instance.
            ...
            mysql_replica_configuration:
                description:
                    - MySQL specific configuration when replicating from a MySQL on-premises main. Replication
                ...
                suboptions:
                    ...
                    client_key:
                        description:
                            - PEM representation of the subordinate's private key. The corresponsing public key is encoded
                    ...
                    dump_file_path:
                        description:
                            - Path to a SQL dump file in Google Cloud Storage from which the subordinate instance is
                              ...
                              replication should begin. This can be accomplished by setting --main-data to 1
                    ...
                    verify_server_certificate:
                        description:
                            - Whether or not to check the main's Common Name value in the certificate that it
