...
class Operation(Model):
    ...
    :param geo_main_operation_id: Applicable only for stamp operation ids.
    :type geo_main_operation_id: str
    """
    ...
    _attribute_map = {
        ...
        'geo_main_operation_id': {'key': 'geoMainOperationId', 'type': 'str'},
    }

    def __init__(self, id=None, name=None, status=None, errors=None, created_time=None, modified_time=None, expiration_time=None, geo_main_operation_id=None):
        self.id = id
        self.name = name
        self.status = status
        self.errors = errors
        ...
        self.geo_main_operation_id = geo_main_operation_id
