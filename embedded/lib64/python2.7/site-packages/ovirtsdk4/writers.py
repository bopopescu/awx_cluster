...
class BondingWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.options is not None:
            OptionWriter.write_many(obj.options, writer, 'option', 'options')
        if obj.subordinates is not None:
            HostNicWriter.write_many(obj.subordinates, writer, 'host_nic', 'subordinates')
        if obj.active_subordinate is not None:
            HostNicWriter.write_one(obj.active_subordinate, writer, 'active_subordinate')
        writer.write_end()
...
class StorageDomainWriter(Writer):
    ...
    def write_one(obj, writer, singular=None):
        ...
        if obj.main is not None:
            Writer.write_boolean(writer, 'main', obj.main)
        if obj.name is not None:
            Writer.write_string(writer, 'name', obj.name)
        if obj.status is not None:
            Writer.write_string(writer, 'status', obj.status.value)
