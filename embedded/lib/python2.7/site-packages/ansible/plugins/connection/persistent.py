...
class Connection(ConnectionBase):
    ...
    def _start_connection(self):
        ...
        p = subprocess.Popen(
            ...
            stdin=subordinate, stdout=subprocess.PIPE, stderr=subprocess.PIPE
        )
        ...
        try:
            ...
            write_to_file_descriptor(main, {'ansible_command_timeout': self.get_option('persistent_command_timeout')})
            write_to_file_descriptor(main, self._play_context.serialize())
