...
<head>
    ...
    <script>
        ...
        <link href="{{ STATIC_URL }}css/vendor.c18f487cbfb913150ae4.css" rel="stylesheet" />
    
        <link href="{{ STATIC_URL }}css/app.1b37abbc2eec6da97db1.css" rel="stylesheet" />
    
    
        <script src="{{ STATIC_URL }}js/vendor.c18f487cbfb913150ae4.js"></script>
    
        <script src="{{ STATIC_URL }}js/app.1b37abbc2eec6da97db1.js"></script>
