...
class ContainerServiceMainProfile(Model):
    """Profile for the container service main.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :param count: Number of mains (VMs) in the container service cluster.
     Allowed values are 1, 3, and 5. The default value is 1. Default value: 1 .
    :type count: int
    :param dns_prefix: DNS prefix to be used to create the FQDN for the main
     pool.
    :type dns_prefix: str
    ...
    :param os_disk_size_gb: OS Disk Size in GB to be used to specify the disk
     size for every machine in this main/agent pool. If you specify 0, it
     will apply the default osDisk size according to the vmSize specified.
    :type os_disk_size_gb: int
    :param vnet_subnet_id: VNet SubnetID specifies the vnet's subnet
     identifier. If you specify either main VNet Subnet, or agent VNet
    ...
    :param first_consecutive_static_ip: FirstConsecutiveStaticIP used to
     specify the first static ip of mains. Default value: "10.240.255.5" .
    ...
    :ivar fqdn: FDQN for the main pool.
    :vartype fqdn: str
    """
    ...
    def __init__(self, dns_prefix, vm_size, count=1, os_disk_size_gb=None, vnet_subnet_id=None, first_consecutive_static_ip="10.240.255.5", storage_profile=None):
        super(ContainerServiceMainProfile, self).__init__()
        self.count = count
