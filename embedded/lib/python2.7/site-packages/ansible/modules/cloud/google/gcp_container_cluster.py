...
options:
    ...
    main_auth:
        ...
        suboptions:
            ...
            password:
                description:
                    - The password to use for HTTP basic authentication to the main endpoint. Because
                      the main endpoint is open to the Internet, you should create a strong password.
                required: false
    ...
    endpoint:
        description:
            ...
            - The endpoint can be accessed from the internet at https://username:password@endpoint/  See
              the mainAuth property of this resource for username and password information.
        returned: success
        type: str
...
def main():
    ...
    module = GcpModule(
        argument_spec=dict(
            ...
            main_auth=dict(type='dict', options=dict(
