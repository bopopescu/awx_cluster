...
class ContainerService(Resource):
    ...
    :param main_profile: Properties of main agents.
    :type main_profile: :class:`ContainerServiceMainProfile
     <azure.mgmt.compute.containerservice.v2017_01_31.models.ContainerServiceMainProfile>`
    ...
    _attribute_map = {
        ...
        'main_profile': {'key': 'properties.mainProfile', 'type': 'ContainerServiceMainProfile'},
    ...
    def __init__(self, location, main_profile, agent_pool_profiles, linux_profile, tags=None, orchestrator_profile=None, custom_profile=None, service_principal_profile=None, windows_profile=None, diagnostics_profile=None):
