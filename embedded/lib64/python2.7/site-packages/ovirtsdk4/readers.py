...
class BondingReader(Reader):
    ...
    def read_one(reader):
        ...
        while reader.forward():
            tag = reader.node_name()
            if tag == 'active_subordinate':
                obj.active_subordinate = HostNicReader.read_one(reader)
            elif tag == 'ad_partner_mac':
                obj.ad_partner_mac = MacReader.read_one(reader)
            elif tag == 'options':
                obj.options = OptionReader.read_many(reader)
            elif tag == 'subordinates':
                obj.subordinates = HostNicReader.read_many(reader)
            else:
                reader.next_element()
        for link in links:
    ...
    def read_one(reader):
        ...
        while reader.forward():
            ...
            if tag == 'available':
                ...
                obj.main = Reader.read_boolean(reader)
            elif tag == 'name':
                obj.name = Reader.read_string(reader)
            elif tag == 'permissions':
                obj.permissions = PermissionReader.read_many(reader)
