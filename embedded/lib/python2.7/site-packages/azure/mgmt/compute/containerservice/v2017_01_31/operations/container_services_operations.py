...
class ContainerServicesOperations(object):
    ...
    def list(
        ...
        orchestrator, number of mains and agents, and FQDNs of mains and
        agents.
    ...
    def create_or_update(
        ...
        of orchestrator, mains, and agents.
    ...
    def get(
        ...
        including state, orchestrator, number of mains and agents, and FQDNs
        of mains and agents. .
    ...
    def list_by_resource_group(
        ...
        service including state, orchestrator, number of mains and agents,
