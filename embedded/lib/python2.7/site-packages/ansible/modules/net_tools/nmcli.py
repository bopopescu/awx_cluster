...
options:
    ...
    type:
        ...
        choices: [ ethernet, team, team-subordinate, bond, bond-subordinate, bridge, bridge-subordinate, vlan, generic ]
    mode:
        description:
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            main=dict(required=False, default=None, type='str'),
            ifname=dict(required=False, default=None, type='str'),
            type=dict(required=False, default=None,
                      choices=['ethernet', 'team', 'team-subordinate', 'bond',
                               'bond-subordinate', 'bridge', 'bridge-subordinate',
                               'vlan', 'generic'],
                      type='str'),
            ...
            subordinatepriority=dict(required=False, default="32", type='str'),
