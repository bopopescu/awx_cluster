...
class ContainerService(Resource):
    ...
    :param main_profile: Profile for the container service main.
    :type main_profile:
     ~azure.mgmt.containerservice.models.ContainerServiceMainProfile
    ...
    def __init__(self, location, orchestrator_profile, main_profile, linux_profile, tags=None, custom_profile=None, service_principal_profile=None, agent_pool_profiles=None, windows_profile=None, diagnostics_profile=None):
