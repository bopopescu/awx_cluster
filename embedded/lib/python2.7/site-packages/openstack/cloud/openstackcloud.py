...
class OpenStackCloud(_normalize.Normalizer):
    ...
    def create_zone(self, name, zone_type=None, email=None, description=None,
        ...
        :param mains: Main nameservers (only applies
    ...
    @_utils.valid_kwargs('email', 'description', 'ttl', 'mains')
    ...
    @_utils.valid_kwargs('name', 'image_id', 'flavor_id', 'main_flavor_id',
    ...
    def node_set_provision_state(self,
        ...
        # Setting locally until we have determined our main plan regarding
